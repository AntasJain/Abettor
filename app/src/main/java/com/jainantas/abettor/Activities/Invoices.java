...
public class Invoices extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        heading.setText("Bills and Invoices");
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent newIntent=new Intent(getApplicationContext(),UploadImage.class);
                SharedPreferencesHelper.setUserInfo("From","invoices");
                SharedPreferencesHelper.setUserInfo("To","Wealth");
               startActivity(new Intent(getApplicationContext(), UploadImage.class));
            }
        });
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        Query query=db.collection(SharedPreferencesHelper.getUserInfo(PrefsData.emailId,null)).document("Wealth").collection("invoices")
